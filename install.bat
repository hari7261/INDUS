...
REM Copy files
echo Copying files...
copy /Y indus.exe "%INSTALL_DIR%\indus.exe" >nul
if exist indus-core.exe copy /Y indus-core.exe "%INSTALL_DIR%\indus-core.exe" >nul
...
echo   3. Open any Command Prompt and type: indus
echo.
