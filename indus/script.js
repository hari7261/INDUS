...
const sequence = [
  { type: 'prompt', text: 'color o' },
  { type: 'out',    text: '● Prompt changed to Orange' },
  { type: 'prompt', text: 'http get https://api.github.com/users/hari7261' },
  { type: 'out',    text: '{ "login": "hari7261", "public_repos": 176, ... }' },
  { type: 'prompt', text: 'run --workers 4 --tasks 10 | http post https://httpbin.org/post' },
  { type: 'out',    text: '{"json": {"completed": 10, "failed": 0, "total": 10}}' },
  { type: 'ok',     text: '✓ Pipeline completed in 0.84s' },
];
...
window.showColorDemo = function(key, name) {
  ...
  document.getElementById('modal-desc').textContent =
    `color ${key} — ${name} prompt  •  type "color ${key}" inside INDUS to apply`;
